...
`actor_location` = IF(length(${actor_location})>0,${actor_location},`actor_location`),
...
`author_association` = IF(length(${author_association})>0,${author_association},`author_association`),
